...
static EGLBoolean GLAD_API_PTR glad_debug_impl_eglStreamImageConsumerConnectNV(EGLDisplay dpy, EGLStreamKHR stream, EGLint num_modifiers, EGLuint64KHR * modifiers, EGLAttrib * attrib_list) {
    EGLBoolean ret;
